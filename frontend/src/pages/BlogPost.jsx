  ...
  return (
    <>
      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 mt-16 bg-white">
        ...
        {/* Back Link */}
        <Link to="/journal" className="inline-flex items-center text-sm text-gray-500 hover:text-rose-500 transition-colors mb-8 font-inter font-medium tracking-wide">
        ...
        <header className="mb-10 text-center">
          <div className="flex items-center justify-center gap-2 mb-6 flex-wrap">
            {blog.tags && blog.tags.map((tag, i) => (
              <span key={i} className="text-xs font-bold uppercase tracking-widest text-rose-500 bg-rose-50 px-4 py-1.5 rounded-full">
                {tag}
              </span>
            ))}
          </div>
        ...
        {/* Rich Text Content */}
        <div 
          className="prose prose-lg max-w-none font-inter text-gray-700 prose-headings:font-playfair prose-headings:font-semibold prose-a:text-rose-500 prose-img:rounded-xl prose-rose"
