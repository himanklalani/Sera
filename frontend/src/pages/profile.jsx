...
const Profile = () => {
    ...
    const fetchProfile = async () => {
      ...
      try {
        ...
        try {
            ...
            // Don't fail the whole profile load if orders fail
        }
  ...
  const handleUpdateProfile = async (e) => {
      ...
      // Update local storage with full response data which includes token
      localStorage.setItem('userInfo', JSON.stringify(data));
      setUserInfo(data);
      setProfileData({ ...profileData, name: data.name, email: data.email, password: '', confirmPassword: '' }); // Reset passwords
